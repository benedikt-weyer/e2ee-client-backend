...
The intended default entrypoint is `E2eeBackend` plus the generated outputs exported by `e2ee-backend-adapter`.
...
- prefer importing typed models, transport, auth, schema, and REST adapter helpers from the generated TypeScript module
